...
export type CloudPubSubMessage = {
  ...
  /**
   * Removes the message from our inventory and schedules it to be
   * redelivered immediately. Do **not** acknowledge the message
   * (allows more messages to be retrieved if your limit was hit).
   */
  nack: () => void;
};
